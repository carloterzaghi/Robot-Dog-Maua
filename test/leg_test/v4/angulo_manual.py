...
servo_femur = kit.servo[10]   # Theta 2: fêmur — braço 120 mm (Servo Superior do encaixe da perna)
servo_tibia = kit.servo[8]   # Theta 3: tíbia — braço 130 mm (Servo Inferior do encaixe da perna)
